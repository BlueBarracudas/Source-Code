		  ...
		  <div class="navbar-header">
		    ...
		    <div>
		     <ul class="nav nav-tabs navbar-nav">
		     	<li id="home"><a href="superAdminHomePage.php" class="navigation">Home</a></li>
				<li id="RegisterCompany"><a href="company-registration.php">Register Company</a></li>
    			<li id="RegisterAdmin"><a href="superAdminRegisterAdmin.php">Register Admin</a></li>
    			<li id="ListOfAdmins"><a href="superAdminViewListOfAdmins.php">JobIT Admins</a></li>
            </ul>
		      <ul class="nav navbar-nav navbar-right">
				...
				<button id="notifSettings" class="btn btn-default btn-fill"  data-toggle="modal" data-target="#notifModal"><center>Notification Settings</center></button>
                   ...
                   <?php echo $ap->get_email() ?>  <span class="caret"></span></a>
		          	<ul class="dropdown-menu" role="menu">
		            <li id="settings"><a href="#">Edit Account Info</a></li>
