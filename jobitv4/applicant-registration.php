...
<div class="container" id="container1">
  <div class="row col-md-offset-1 col-md-10">
    ...
    <form class="form-horizontal" id="registrationForm" role="form" method="POST" action="logic/logic_applicantregistration/php">
...
<div class="panel-heading">
 ...
 <div id="body">
 <form action="logic/logic_applicantsetup.php" enctype="multipart/form-data" method ="post">
<br>
