	...
	include 'model.php';
		...
		function createApplicantProfile($prid, $apid, $sk, $sc, $col, $cou, $cer, $we, $file)
		{
             ...
             if(isset($_POST['skills']))
            {
             ...
             if(isset($_POST['jobtitle']) && isset($_POST['workExp']) && isset($_POST['company']))
             {
                $arr1 = array();
                $arr1 = $_POST['jobtitle'];
                $arr2 = array();
              ...
              for($i=0;$i<$cnt;$i++)
              {
                 $query="INSERT INTO `jobit`.`work_experience`(`applicant_id`,`work_title`,`years`,`company_name`)VALUES('$apid','$arr1[$i]','$arr2[$i]','$com[$i]');";
                  echo $query;
...
$result = mysqli_query($connect, $query);
            ...
            if(isset($_POST['certification']) && isset($_POST['dateAchieved']))
            {
                $arr = array();
              ...
              for($i=0;$i<$cnt;$i++)
              {
                 $query="INSERT INTO `jobit`.`certificate`(`certificate_name`,`applicant_id`,`date`,`competency`,`is_valid`)VALUES('$arr[$i]','$apid','$date[$i]',1,0);";
