...
$( "#certadd" ).click(function(){
    ...
    $newdateachievedinput.append($('<input class="form-control input-sm classhschool" type="text" name="dateAchieved[]">'));
    //Append the input
    ...
    var $newcertcompetency = $('<div class="checkbox"><label><input class="competency-checkbox" type="checkbox" name=certBox[]/>Certificate of Competency</label> <span class="glyphicon glyphicon-question-sign" data-toggle="tooltip" title="<insert desc. here>"></span></div>');
