<?php
	...
	include 'model.php';
		...
		function createApplicantProfile($prid, $apid, $sk, $sc, $col, $cou, $cer, $jt, $we, $file)
		{
			...
			$sql = "INSERT INTO applicantprofile(applicant_profile_id, applicant_id, skills, HS_name, college_name, course, certificates, work_experience, resume_pdf, profile_picture) 
			VALUES ('$prid', '$apid', '$sk', '$sc', '$col', '$cou', '$cer', '$we', '$file', 'hehe.jpg');";
