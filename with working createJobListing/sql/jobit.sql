...
CREATE TABLE IF NOT EXISTS `jobit`.`certificate` (
  ...
  `competency` INT(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `jobit`.`joblisting` (
  ...
  `exp_tag` VARCHAR(150) NULL,
  `cert_tag` VARCHAR(150) NULL,
...
-- -----------------------------------------------------
-- Table `jobit`.`workExpJobListing`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `jobit`.`workExpJobListing` (
...
-- -----------------------------------------------------
-- Table `jobit`.`certJobListing`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `jobit`.`certJobListing` (
