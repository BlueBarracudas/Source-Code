...
<div class="panel-heading">
                                  <h3 class="panel-title" id="SetupHeader">Create Job Listing <p style="color:black;"></p> </h3>
 ...
 <div id="body">
 <form action="companyLogic/companyCreateJobListing.php" method ="post">
  <h3> Work Details </h3>
<br>
...
<br>
 ...
 <div class="row">
     ...
     <div class="col-sm-9">
         <div id="courselist">
          ...
          <select id="collegeCourseInput" onchange="otherCourse(this)" name="collegeCourseInput" class="form-control" >
                            ...
                            <option value="BS-CE">BS-CE (Computer Engineering)</option>
     ...
     <br>
      ...
      <div class="row">
	            <div class="col-md-3"><label>Location:<span style="color:red">*</span></label></div>	
            ...
            <br><br>
             <div id="schedInputGroup">      
                  <div class="input-group" id="sched">
                    <input type="checkbox" id="monday" name="monday"> Monday</input>
                  </div>
                  <div class="input-group" id="sched">
                    <input type="checkbox" id="tuesday" name="tuesday"> Tuesday</input>
                  </div>
                  <div class="input-group" id="sched">
                    <input type="checkbox" id="wednesday" name="wednesday"> Wednesday</input>
                  </div>
                  <div class="input-group" id="sched">
                    <input type="checkbox" id="thursday" name="thursday"> Thursday</input>
                  </div>
                  <div class="input-group" id="sched">
                    <input type="checkbox" id="friday" name="friday"> Friday</input>
                  </div>
                  <div class="input-group" id="sched">
                    <input type="checkbox" id="saturday" name="saturday"> Saturday</input>
                  </div>
                  <div class="input-group" id="sched">
                    <input type="checkbox" id="sunday" name="sunday"> Sunday</input>
                  </div>
 ...
 <br>
  ...
  <input class="form-control input-sm" type="number" min="0" name="workExp[]">
             ...
             <select class="form-control input-sm classcert" onchange="otherCert(this)" type="text" name="certification[]" id="certification[]">
              ...
              <option value="Other" >Other</option>
                            ...
                            <div id="otherCertification">
                              ...
                              <div class="col-md-9">
                                <input class="form-control otherCert-input input-sm othercourse" type="text" id="othercourse" name="certification[]">
                              </div>
                              <br>
                              <br>
                            </div>
