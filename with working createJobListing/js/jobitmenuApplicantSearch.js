		    ...
		    '<div>'+
		     ' <ul class="nav nav-tabs navbar-nav">'+
		      '<li id="home"><a href="applicantHomePage.html" class="navigation">Home</a></li>'+
		        '<li id="profile"  ><a href="applicantViewProfile.html" class="navigation">Profile</a></li>'+
		        '<li id="search" class="active"><a href="applicantSearch.html"class="navigation">Search Job Listings</a></li> '+
